...
% 
% 
% simin = timeseries([ctrl, pendPosZD, pendPosZU, pendVel, diskPos, diskVel] , t);
...
% for i = 1:6
%     subplot(3, 2, i); 
%     plot(t, measured_data{i}, 'r--', 'LineWidth', 1.5); 
%     hold on;
%     plot(sim_t, sim_data(:, i), 'b', 'LineWidth', 1.2); 
%     title(titles{i});
%     xlabel('Czas [s]');
%     ylabel('Amplituda');
%     grid on;
